...
public class DifficultyDirector : MonoBehaviour
{
    ...
    [SerializeField] float currentDriverTenureSeconds;
    [SerializeField] int currentDriverTenureSteps;
    [SerializeField] float currentDriverTenure01;
    [SerializeField] float currentDriverAdvantage01;
    ...
    void Update()
    {
        ...
        foreach (var kv in profiles)
        {
            ...
            if (enableDriverTenure && p == CurrentDriver && driverTenure01Local > 0f)
            {
